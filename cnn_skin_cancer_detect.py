# -*- coding: utf-8 -*-
"""CNN_skin_cancer_detect.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11bkg8NZs6RFCyNuWhN4Z3GdMsFlltVRZ
...
The dataset is taken from the ISIC (International Skin Image Collaboration) Archive. It consists of 1800 pictures of benign  and 1497 pictures of malignant classified cancer. The pictures have all been resized to low resolution (224x224x3) RGB. The task of this kernel is to create a model, which can classify the cancer visually into benign and malignant. 
